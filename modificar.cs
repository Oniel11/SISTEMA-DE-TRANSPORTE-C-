...
namespace sistemaClientes
{
    public partial class modificar : Form
    {
        ...
        private void Modificar_Load(object sender, EventArgs e)
        {
            ...
            txtnombres.DataBindings.Add("Text", bs, "MARCA");
            txtapellidop.DataBindings.Add("Text", bs, "COLOR");
            txtapellidom.DataBindings.Add("Text", bs, "MODELO");
            txtcel.DataBindings.Add("Text", bs, "AÑO");
